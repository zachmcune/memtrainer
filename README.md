...
- **Random card** — shoot a card out of the deck with a spin flourish. It lands face up with its Mnemonica number (and the cards beside it) for mem-deck tricks. A toggle lets the same card come up again, or deals through the deck once.
